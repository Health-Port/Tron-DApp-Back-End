const ResponseMessagesEnum = {
    ...
    CHARACTER_COUNT_ERROR: 'Name should be less than 100 Characters.',
    ...
    FEATURE_PARENT_IS_SAME: 'Feature and parent id can not be same.',
    ...
    RECORD_ALREADY_SHRED: 'Record already shared.',
